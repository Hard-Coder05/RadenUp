...
class _HomeState extends State<Home> {
  ...
  initState() {
    ...
    FirebaseAdMob.instance
        .initialize(appId: 'ca-app-pub-7309415230190453~2798560443');
    videoAd.load(
        adUnitId: 'ca-app-pub-7309415230190453/5992017222',
                                    ...
                                    if (string == "1" || string == "2") {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            title: Text(
                                                'You are not connected to any Network Services'),
                                            content: Text(
...
MobileAdTargetingInfo targetingInfo = MobileAdTargetingInfo(
  ...
  testDevices: <String>[
    "6347E1469C9B0EDCF60ECE5FC693D323"
